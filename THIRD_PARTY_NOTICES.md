...
The project-authored `bio-gothic-surface.jpg` and the 1K fur, tactical-armor, and hive-chitin PBR
map sets under `public/assets/materials/` were generated and processed specifically for this game.
No user inspiration image is embedded in any runtime texture.
